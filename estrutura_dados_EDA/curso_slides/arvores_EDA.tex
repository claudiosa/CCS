...
\frame{
    \frametitle{Representação  Computacional de uma Arvore Genérica}
    
     \begin{figure}[!ht]
     \centering
    \includegraphics[width=9cm, height=9cm]{figs/fig_arvores/rep_generica_arv00.pdf}
    \caption{O que há de estranho?}
    \end{figure}

    \centering
    \textcolor{red}{O que há de estranho?}
}

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{orientacoes_gerais_EDA}
\include{ponteiros_EDA}
\include{pilhas_EDA} % cap 0

%\include{filas_EDA} % cap 0
%\include{listas_EDA} % cap 0
%\include{recursao_EDA} % cap 0
%\include{arvores_EDA} % cap 0
%\include{hash_EDA} % cap 0

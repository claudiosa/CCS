...
\begin{figure}[ht]
				\centering
			%	\includegraphics[width=.6\textwidth]{01-img/filas/exemplo_fila_tres_elementos.png}				
...
\begin{itemize}
	...
	\begin{figure}[ht]
				\centering
			%	\includegraphics[width=.6\textwidth]{01-img/filas/exemplo_fila_tres_retirada.png}				
...
\begin{itemize}
	...
	\begin{figure}[ht]
				\centering
			%	\includegraphics[width=.6\textwidth]{01-img/filas/exemplo_fila_tres_inclusao.png}				
...
\begin{frame}{Implementação de Fila com Vetor}
	...
	\begin{figure}[ht]
				\centering
				%\includegraphics[width=.6\textwidth]{01-img/filas/fila_insercao_quatro_elementos.png}				
...
\begin{frame}{Implementação de Fila com Vetor}	
	\begin{figure}[ht]
				\centering
				%\includegraphics[width=.6\textwidth]{01-img/filas/exemplo_fila_remove_dois_elementos.png}				

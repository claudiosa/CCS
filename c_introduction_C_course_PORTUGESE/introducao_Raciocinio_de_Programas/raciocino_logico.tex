...
\begin{itemize}
  \item Este texto reflete as dificuldades básicas que alunos
tiveram na disciplina de ALP em semestre anteriores.

  \item \underline{Objetivo}: entender as condições binárias (\texttt{0: false} e \texttt{1: true}) de expressões lógicas

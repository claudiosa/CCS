...
\vspace{0.5cm}
\ding{224} Alguns fontes e materiais de apoio (incluindo este enunciado) estão em: \textbf{\url{https://github.com/CCS/prolog}} 
...
Como as férias estão se aproximando ... nada como um acampamento de férias para voce 

...
\graphicspath{{/home/ccs/Dropbox/figs_genericas/}{figuras/}{/home/ccs/Dropbox/CCS/minizinc/}{minizinc/}}
...
\begin{frame}
    ...
    \begin{itemize}
      \item Sintaxe %%Velocidade de implementação
...
\begin{frame}
    ...
    \begin{itemize}
      ...
      \item Na \textbf{l}ógica de \textbf{p}rimeira-\textbf{o}rdem (LPO) os objetos são chamados por Termos.
      \item O destaque de Picat é a sua natureza declarativa, funcional, tipagem dinâmica, e sintaxe
...
\begin{frame}
 ...
 \item         Uma variável atribuída pode imitar várias variáveis lógicas, alterado seu valor seguindo o estado da computação. 
...
\begin{frame}
    ...
    \textbf{Actors}: \textcolor{red}{ \textbf{REFAZER não é nada disto ...}}
  \begin{itemize}
...
\item 		Neste ponto, estes atores desempenham características de área de Inteligência Artificial, especificamente a áreas de planejamento e sistemas multi-agentes.
    \end{itemize}   
\end{frame}
...
\begin{frame}
	...
	\item 	Com esta técnica de memoization, o Picat oferece soluções imediatas para problemas de programação dinâmica.
    \end{itemize}
\end{frame}

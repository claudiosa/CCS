...
import IO
import System
import Char (toUpper , isDigit) -- do módulo Char vou usar
-- toUpper e isDigit...
---------------------------------------------------------------
-- Main, Menus e 	IOs				     --
---------------------------------------------------------------
...
escolha_menu i =
  do{
    ...
    if not(i=='S') then menu else putStr "";
  }
...
m_inserir =
  do{
    ...
    compra <- pega_compra;
    venda <- pega_venda;
    -- Cuidar .... o nome do arquivo de entrada...

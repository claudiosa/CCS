...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.67\textheight]{figuras/passaros_australia.jpg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.67\textheight]{figuras/fumaca_complexa.jpg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.67\textheight]{figuras/the_imitation_game_01.jpg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.67\textheight]{figuras/tic_tac_toe.jpg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.9\textwidth , height=0.7\textheight]{figuras/areas_da_IA.jpg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.9\textwidth , height=0.7\textheight]{figuras/agente_ambiente.jpg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.6\textheight]{figuras/google-car.jpg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.6\textheight]{figuras/watson-pgm.jpg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.6\textheight]{figuras/drones.jpeg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.6\textheight]{figuras/ant01.jpg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.6\textheight]{figuras/ant02.jpg}
%\caption{Computação Inspirada em Seres Biológicos (sua evolução \textit{Darwiniana})} 
%\label{}
\end{figure}
\end{frame}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.6\textheight]{figuras/ant03.jpg}
%\caption{Computação Inspirada em Seres Biológicos (sua evolução \textit{Darwiniana})} 
%\label{}
\end{figure}
\end{frame}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , heparight=0.6\textheight]{figuras/parents_offsprings.jpg}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.9\textwidth , height=0.7\textheight]{figuras/optimization_ant_colony_algorithm.png}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.4\textwidth , height=0.6\textheight]{figuras/x_tree.pdf}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.65\textheight]{figuras/xy_tree.pdf}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.65\textheight]{figuras/xyz_tree.pdf}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.6\textheight]{figuras/classes_problemas.pdf}
...
\frame{
    ...
    \begin{figure}[tbp]
    \includegraphics[keepaspectratio=true,width=4in]{figuras/elementos-da-otimizacao.pdf}
    \centering
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.7\textheight]{figuras/cabo-de-guerra.jpg}
% \caption{} 
%\label{}
\end{figure}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[width=0.8\textwidth , height=0.6\textheight]{figuras/binary_tree04.pdf}
...
\begin{figure}[h!b]
\begin{center}
\includegraphics[width=0.7\textwidth , height=0.7\textheight]{figuras/Execution-Time-NP-01.pdf}
\caption{O limite dos NPs}
\label{fig_Execution-Time-NP-01}
\end{center}
\end{figure}

% \includegraphics[width=0.7\textwidth , height=0.7\textheight]{figuras/meus-codigos-fontes.jpeg}
...
\begin{figure}[!hb]
\begin{center}
\includegraphics[width=0.7\textwidth , height=0.7\textheight]{figuras/Execution-Time-NP-03.pdf}
...
\frametitle{Perguntas e Referências}
  ...
  \begin{center}
%   \includegraphics[scale=0.6,keepaspectratio]{figuras/simpsons.jpg} 
   \includegraphics[scale=0.35,keepaspectratio]{figuras/test_intelligence01.jpg} 
  \end{center} 

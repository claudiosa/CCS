...
\vspace*{-3em}
\includegraphics[width=0.35\textwidth]{figures/minha_risada_02.jpg}
...
\PersonalEntry{Linkedin}{\underline{\url{https://www.linkedin.com/in/claudio-cesar-de-sa/}}}
...
%%% Work experience
%%% ------------------------------------------------------------
\NewPart{Work experience}(Only, the most recent activities)%{I am describing here, only, the most recent jobs:}
...
\NewPart{Profile Summary}{} %Academic Production

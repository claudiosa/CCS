...
\title[Picat]{\fontsize{20}{30}\selectfont \textcolor{black}{Conjuntos em Figuras -- ALP}}
...
\begin{figure}[!ht]
\centering
\includegraphics[height =.85\textheight,width=.65\textwidth]
{figuras/explica_conjuntos.pdf}
...
\frametitle{Função Pertence}


\begin{figure}[!ht]
\centering
\includegraphics[height =.85\textheight,width=.65\textwidth]
{figuras/explica_pertence.pdf}
%%%\caption{Agente situado versus a visão clássica de sistemas inteligentes}
%\label{ag_01}
\end{figure}
\end{frame}
...
Implementação: do-while; while; for
